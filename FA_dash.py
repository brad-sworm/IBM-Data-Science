...
app.layout = [
    html.H1(children='Automobile Sales Statistics Dashboard', style={'textAlign':'center'}),
...
#          Hint:Use the columns Year and Automobile_Sales
        ...
        Y_chart3 = dcc.Graph(figure=px.bar(avr_vdata,
            x = 'Month',
            y = 'Automobile_Sales',
            title=f'Average Vehicles Sold by Vehicle Type in the year {input_year}'.format(input_year)))
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(
            ...
            values='Advertising_Expenditure',
            names='Vehicle_Type',
            title=f'Total Advertisment Expenditure for Each Vehicle in the year {input_year}'))
